...
echo "  2. (Optional) Build Flutter web UI for full testing:"
echo "     cd $PROJECT_ROOT"
echo "     flutter pub get"
echo "     flutter build web"
echo "     See TESTING_GUIDE.md for detailed Flutter setup instructions"
echo "  3. Start services: cd $SCRIPT_DIR && ./run_local.sh"
